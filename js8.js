...
function init() {
     scrollOffset = 0;
     player = new Player();
     platforms = [new Platform(-3, 470, platformImg), new Platform(700, 470, platformImg), new Platform(1400, 470, platformImg)];
     bgs = [new Bg(-3, -3, bgImg), new Bg(-3, -3, hillsImg), new Bg(900, 200, hillsImg),] 
}
